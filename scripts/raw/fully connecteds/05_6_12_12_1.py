# -*- coding: utf-8 -*-
"""
Created on Wed Jul 10 20:34:03 2019
...
dataset = pd.read_csv("stgo_provi_lcdes.csv")
...
ANN_Baseline.add(Dense(12, input_dim=5, activation="sigmoid"))
ANN_Baseline.add(Dense(12, activation="sigmoid"))
...
metrics.to_csv("metrics/05_5_12_12_1_metrics.csv")
