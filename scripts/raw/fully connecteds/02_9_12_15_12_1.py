...
@author: Bastolo
"""
print("\nIniciando Script 02_9_12_15_12_1.py ...\n")
...
ANN_Baseline.add(Dense(12, input_dim=9, activation="tanh"))
ANN_Baseline.add(Dense(15, activation="tanh"))
ANN_Baseline.add(Dense(12, activation="tanh"))
ANN_Baseline.add(Dense(1, activation="linear"))

"""
l1_bias = np.loadtxt("weights/02_9_12_15_12_1/bias1.csv", delimiter=",")
l1_weights = np.loadtxt("weights/02_9_12_15_12_1/weights1.csv", delimiter=",")
l2_bias = np.loadtxt("weights/02_9_12_15_12_1/bias2.csv", delimiter=",")
l2_weights = np.loadtxt("weights/02_9_12_15_12_1/weights2.csv", delimiter=",")
l3_bias = np.loadtxt("weights/02_9_12_15_12_1/bias3.csv", delimiter=",")
l3_weights = np.loadtxt("weights/02_9_12_15_12_1/weights3.csv", delimiter=",")
l4_bias = np.loadtxt("weights/02_9_12_15_12_1/bias4.csv", delimiter=",").reshape(-1)
l4_weights = np.loadtxt("weights/02_9_12_15_12_1/weights4.csv", delimiter=",").reshape(-1)
...
np.savetxt("weights/02_9_12_15_12_1/weights1.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias1.csv", bias1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/weights2.csv", weights2, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias2.csv", bias2, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/weights3.csv", weights3, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias3.csv", bias3, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/weights4.csv", weights4, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias4.csv", bias4, delimiter=",", fmt="%s")
...
plt.savefig("Mse_9_12_15_12_1.png")
plt.show()
...
metrics.to_csv("metrics/02_9_12_15_12_1_metrics.csv")
