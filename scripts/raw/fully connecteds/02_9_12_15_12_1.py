...
np.savetxt("weights/02_9_12_15_12_1/bias1.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/weights2.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias2.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/weights3.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias3.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/weights4.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/02_9_12_15_12_1/bias4.csv", weights1, delimiter=",", fmt="%s")
