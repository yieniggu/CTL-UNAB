...
ANN_Baseline.add(Dense(15, input_dim=13, activation="relu"))
ANN_Baseline.add(Dense(17, activation="relu"))
...
np.savetxt("weights/00_13_15_17_15_1/weights1.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/bias1.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/weights2.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/bias2.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/weights3.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/bias3.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/weights4.csv", weights1, delimiter=",", fmt="%s")
np.savetxt("weights/00_13_15_17_15_1/bias4.csv", weights1, delimiter=",", fmt="%s")
...
metrics.to_csv("00_13_15_17_15_1_metrics.csv")
